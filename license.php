    ...
    <div class="min-h-screen py-20 px-6">
        <div class="max-w-4xl mx-auto">
            ...
            <p class="text-center text-gray-500 mb-12">
                Informasi lisensi penggunaan konten dan layanan Glad2Glow
            </p>

            <div class="license-box space-y-8 text-gray-600 text-sm leading-relaxed">
                ...
                <div>
                    ...
                    <p>
                        Seluruh konten yang terdapat pada website Glad2Glow, termasuk teks, gambar,
                        logo, desain, dan fitur lainnya, dilindungi oleh hak cipta dan merupakan
                        milik Glad2Glow.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p>
                        Pengguna diperbolehkan mengakses dan menggunakan konten Glad2Glow untuk
                        keperluan pribadi dan non-komersial. Dilarang menyalin, memodifikasi,
                        mendistribusikan, atau mempublikasikan ulang konten tanpa izin tertulis.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p>
                        Glad2Glow memberikan lisensi terbatas, tidak eksklusif, dan tidak dapat
                        dipindahtangankan kepada pengguna untuk mengakses layanan website sesuai
                ...
                <div>
                    ...
                    <p>
                        Pengguna dilarang menggunakan website untuk tujuan yang melanggar hukum,
                        merugikan pihak lain, atau menyalahgunakan sistem dan layanan Glad2Glow.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p>
                        Apabila terjadi pelanggaran terhadap ketentuan lisensi ini, Glad2Glow berhak
                        menghentikan akses pengguna serta mengambil tindakan sesuai hukum yang berlaku.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p>
                        Ketentuan lisensi dapat diperbarui sewaktu-waktu. Perubahan akan diumumkan
                        melalui halaman ini dan berlaku sejak tanggal pembaruan.
                    </p>
                </div>
            ...
            <p class="text-center text-xs text-gray-400 mt-10">
                © 2025 Glad2Glow. All rights reserved.
            </p>
