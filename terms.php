    ...
    <div class="min-h-screen py-20 px-6">
        <div class="max-w-4xl mx-auto">
            ...
            <p class="text-center text-gray-500 mb-12">
                Syarat dan ketentuan penggunaan website Glad2Glow
            </p>

            <div class="terms-box space-y-8 text-gray-600 text-sm leading-relaxed">

                <!-- Section 1 -->
                <div>
                    <h2 class="text-lg font-semibold text-pink-500 mb-2">
                        1. Ketentuan Umum
                    </h2>
                    <p>
                        Dengan mengakses dan menggunakan website Glad2Glow, pengguna dianggap telah
                ...
                <div>
                    ...
                    <p>
                        Pengguna bertanggung jawab atas keamanan akun, termasuk kerahasiaan username
                        dan password. Glad2Glow tidak bertanggung jawab atas penyalahgunaan akun
                ...
                <div>
                    ...
                    <p>
                        Kami berusaha memberikan informasi produk seakurat mungkin. Namun, perbedaan
                        warna atau hasil dapat terjadi tergantung pada kondisi kulit masing-masing pengguna.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p>
                        Semua pesanan yang masuk akan diproses setelah pembayaran dikonfirmasi.
                        Glad2Glow berhak menolak atau membatalkan pesanan apabila terjadi kesalahan
                        data atau indikasi penyalahgunaan.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p>
                        Estimasi pengiriman mengikuti ketentuan jasa ekspedisi yang dipilih.
                        Glad2Glow tidak bertanggung jawab atas keterlambatan yang disebabkan oleh pihak ketiga.
                    </p>
                </div>
                ...
                <div>
                    <h2 class="text-lg font-semibold text-pink-500 mb-2">
                        6. Pengembalian & Komplain
                    </h2>
                    <p>
                        Pengajuan komplain dapat dilakukan maksimal 1x24 jam setelah produk diterima
                        dengan menyertakan bukti yang jelas sesuai ketentuan yang berlaku.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p>
                        Glad2Glow berhak mengubah isi Terms of Service sewaktu-waktu tanpa pemberitahuan
                        sebelumnya. Pengguna disarankan untuk meninjau halaman ini secara berkala.
                    </p>
                </div>
