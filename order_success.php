...
$order_code = mysqli_real_escape_string($conn, $_GET['order']);
...
<body class="bg-pink-50">
    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-50 py-20 px-6">

        <div class="bg-white max-w-md w-full p-8 rounded-2xl shadow-lg text-center">
            ...
            <p class="text-gray-600 mb-6">
                <?= $isCOD
                    ? 'Your order has been placed. Please prepare cash upon delivery.'
                    : 'Thank you for your purchase! Your payment has been received.' ?>
            </p>

            <!-- ORDER INFO -->
             <!-- meng deklarasikan status pemesanan -->
            <div class="bg-gray-100 rounded-xl p-4 text-left text-sm mb-6">
                <span class="font-semibold 
                    <?= $order['status'] === 'paid' ? 'text-green-600' : 'text-yellow-600' ?>">
                    <?= ucfirst($order['status']) ?>
                </span><br>

                <!-- menggunakan metode pembayaran cod -->
                <span class="font-semibold">
                    <?= $isCOD ? 'Cash On Delivery' : 'Midtrans' ?>
                </span>
            ...
            <div class="space-y-3">
                <a href="./customer/order.php"
                    class="block w-full bg-pink-500 hover:bg-pink-600 text-white py-3 rounded-xl font-semibold transition">
                    📦 View My Orders
                </a>

                <a href="index.php"
                    class="block w-full border border-gray-300 hover:bg-gray-100 text-gray-700 py-3 rounded-xl font-semibold transition">
                    🏠 Back to Home
                </a>
            </div>
